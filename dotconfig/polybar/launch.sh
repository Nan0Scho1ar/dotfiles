...
case $desktop in
    ...
    bspwm|/usr/share/xsessions/bspwm)
        if [ $HOSTNAME == "jupiter" ]; then
            MONITOR=DisplayPort-1 polybar --reload mainbar-bspwm-1 -c ~/.config/polybar/config &
            MONITOR=DisplayPort-1 polybar --reload mainbar-aesthetic-1 -c ~/.config/polybar/config &

            MONITOR=DisplayPort-2 polybar --reload mainbar-bspwm-2 -c ~/.config/polybar/config &
            MONITOR=DisplayPort-2 polybar --reload mainbar-aesthetic-2 -c ~/.config/polybar/config &

            MONITOR=DisplayPort-0 polybar --reload mainbar-bspwm-3 -c ~/.config/polybar/config &
            MONITOR=DisplayPort-0 polybar --reload mainbar-aesthetic-3 -c ~/.config/polybar/config &
        else
